...
import com.wedge.todaypopup.core.navigation.navigator.NavigationCommand
import com.wedge.todaypopup.core.navigation.navigator.Navigator
import kotlinx.coroutines.flow.onCompletion
import kotlinx.coroutines.flow.onSubscription

abstract class TodayPopupNavigator : Navigator() {
    ...
    suspend fun handleNavigationCommands(navController: NavController) {
        navigationCommands
            .onSubscription { this@TodayPopupNavigator.navControllerFlow.value = navController }
            .onCompletion { this@TodayPopupNavigator.navControllerFlow.value = null }
